...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
  ...
  <div class="m-content" style="overflow: scroll;">
			...
			<table class="display" id="doctorstable" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th scope="col">Registration Email</th>
                  <th scope="col">Registration Phone</th>
                  <th scope="col">Registration Type</th>
                  <th scope="col">Registration Info</th>
    ...
    <script src="{{URL::to('public/js/customjs/regdentalcamp.js')}}" type="text/javascript"></script>
@stop